...
function renderLogOutInfo(htmlElmId) {
  var htmlString = "<p>PouÅ¾Ã­vateÄ¾ nie je prihlÃ¡senÃ½</p>";
  document.getElementById(htmlElmId).innerHTML = htmlString;
}
